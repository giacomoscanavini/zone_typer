...
const WORDS_BY_TIER = {
  lowercase: [
    ...
    'grid', 'halo', 'ion', 'jet', 'key', 'laser', 'leaf', 'light', 'loop',
    'maze', 'moon', 'node', 'nova', 'orbit', 'path', 'pixel', 'pulse',
    'quake', 'ray', 'rift', 'rocket', 'scan', 'signal', 'spark', 'star',
    'storm', 'tower', 'unit', 'vector', 'wave', 'xenon', 'zone'
  ],
  capitalized: [
    ...
    'LaserGrid', 'MoonBase', 'NightShift', 'PowerCore', 'StarGate', 'SunRay'
  ],
  numbers: [
    'a1', 'b2', 'c3', 'd4', 'x9', 'z7', '3d', '4g', '7up', '9ball',
    'arc7', 'beam2', 'bolt9', 'core42', 'data8', 'echo5', 'grid3', 'ion2',
    'laser7', 'node11', 'nova6', 'orbit8', 'pulse9', 'sector4', 'zone12',
    'Alpha7', 'Base64', 'Core99', 'Delta5', 'Grid24', 'Laser10', 'Nova8'
  ],
  symbols: [
    'arc!', 'beam?', 'bolt#', 'core$', 'data%', 'echo+', 'flux*', 'grid-',
    'ion_2', 'laser.exe', 'node.js', 'nova@7', 'pulse+', 'ray/gun', 'rift?',
    'scan.io', 'spark!', 'star*9', 'warp-speed', 'x-ray', 'zone!',
    'Alpha#1', 'Beta+2', 'Core-X', 'Grid_7', 'Neo:Zone', 'Pulse.Max'
  ],
  phrases: [
    'red alert', 'blue beam', 'dark grid', 'data stream', 'fire wall',
    'laser gate', 'moon base', 'night shift', 'power core', 'quick scan',
    'safe zone', 'sector seven', 'solar wind', 'star field', 'storm front',
    'warp drive', 'zero hour', 'Alpha Base', 'Beta Test', 'Code Red',
    'Delta Wave', 'Grid Lock', 'Hyper Beam', 'Laser Gate', 'Nova Prime'
  ],
  expert: [
    'Quantum-7', 'Signal_42', 'Star Gate 9', 'Core#Alpha', 'Data.Stream',
    'Phase Shift', 'Zero Hour!', 'Binary Pulse', 'Cyber Shield', 'Hyper Vector',
    'Laser Grid-X', 'Magnetic Field', 'Neon Protocol', 'Orbit Path 12',
    'Plasma Reactor', 'Quantum Tunnel', 'Signal Boost+', 'Solar Flare!',
    'Vector Matrix', 'Zone Control', 'containment field', 'ionization wave',
    'synchronization', 'transmission relay', 'acceleration node'
  ],
};
...
function drawHud() {
  ...
  drawNeonText('V4.0', 254, 82, 13, 'left', '#eafcff', 6);
